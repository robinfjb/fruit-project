...
public class ConfirmOrderParam extends AbstractRequestParams{
	private String cTel;
	private String oId;
	public ConfirmOrderParam(Context context, String tel, String oId) {
		super(context);
		this.cTel = tel;
		this.oId = oId;
	}
	...
	protected Map<String, String> createGetRequestBundle() {
		...
		params.put("do", "customerCompleteOrder");
