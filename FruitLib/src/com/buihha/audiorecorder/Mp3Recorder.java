...
public class Mp3Recorder {
	 ...
	 * @throws IOException
	 */
	public void startRecording(String savePath, String fileName) throws IOException {
		if (isRecording) return;
		Log.d(TAG, "Start recording");
		Log.d(TAG, "BufferSize = " + bufferSize);
		// Initialize audioRecord if it's null.
		if (audioRecord == null) {
			initAudioRecorder(savePath, fileName);
		}
	 ...
	 */
	private void initAudioRecorder(String savePath, String fileName) throws IOException {
